...
if [[ "$1" == "go ref"* ]]; then
    ...
    echo "<item arg='go: snippets' valid='yes' file='no'><title>Snippets</title><subtitle>Search for chunks of text to copy and insert --- Shortcut: ',p snippets'</subtitle><icon>icons/scissor.png</icon></item>" | grep -i "$filter"
