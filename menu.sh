...
if [[ "$1" == "settings "* ]]; then
  echo "<item autocomplete='settings 1a' arg='settings 1a'><title>Setting 1a</title></item>"
  echo "<item autocomplete='settings 2a' arg='settings 2a'><title>Setting 2a</title></item>"
